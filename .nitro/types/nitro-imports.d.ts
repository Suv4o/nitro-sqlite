declare global {
  ...
  const createUser: typeof import('../../utils/user.ts')['createUser']
  ...
  const getUser: typeof import('../../utils/user.ts')['getUser']
  const getUsers: typeof import('../../utils/user.ts')['getUsers']
...
export { createUser, getUsers, getUser } from '../../utils/user';